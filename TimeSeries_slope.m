[a,R]=geotiffread('E:\QHTimeSeries\QH_L5_2010_NDVImax_fvc.tif');%先导入某个图像的投影信息，为后续图像输出做准确
...
for year=2010:2019 %起始年份
    file=['E:\QHTimeSeries\QH_L5_',int2str(year),'_NDVImax_fvc.tif'];%注意自己的名字形式，这里使用的名字是年prec2000.tif，根据这个可修改
    bz=importdata(file);
    bz=reshape(bz,m*n,1);
    data(:,k)=bz;
    k=k+1;
...
name1='E:\QHTimeSeries\QH一元线性回归10-19趋势值.tif';
name2='E:\QHTimeSeries\QH一元线性回归10-19_P值.tif';
name3='E:\QHTimeSeries\QH一元线性回归10-19_R方.tif';
